...
{
   /// <summary>
   /// Property flags for GATT characteristics. See utility methods: <see cref="BluetoothLowEnergyUtils.CanIndicate" />,
   /// <see cref="BluetoothLowEnergyUtils.CanNotify" />, <see cref="BluetoothLowEnergyUtils.CanRead" />,
   /// <see cref="BluetoothLowEnergyUtils.CanWrite" />
   /// </summary>
   /// <remarks>
